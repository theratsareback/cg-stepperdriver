...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LEDPWR_Pin|LEDCON_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, A2_DIR_Pin|A1_DIR_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LEDPWR_Pin LEDCON_Pin */
  GPIO_InitStruct.Pin = LEDPWR_Pin|LEDCON_Pin;
